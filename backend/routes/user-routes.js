...
user_route.get('/viewBuyPets/:email',viewBuyPets)
...
user_route.post('/sendvaccine',sendvaccine)

user_route.post('/buypets',buypets)
// view past vaccine records
user_route.get('/viewPets/:email', viewPets)
user_route.get('/displayRecords/:id', displayRecords)

// appointments viewing 
user_route.get('/boardingRequestsViewing/:email', boardingRequestsViewing)
user_route.get('/cancelBoarding/:id2', cancelBoarding)
user_route.get('/mindrelaxingAppointments/:email', mindrelaxingAppointments)
user_route.get('/cancelMindRelaxingAppointment/:id1', cancelMindRelaxingAppointment)

// bank details
user_route.post('/SubmitBankDetails', SubmitBankDetails)
user_route.get('/getBankDetails/:email', getBankDetails)
