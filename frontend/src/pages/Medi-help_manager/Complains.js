...
const Complains = () => {
    ...
    const email = localStorage.getItem("medi_help_manager");
    ...
    const add_complain = async () => {
        ...
        try {
            const res = await axios.post('http://localhost:5000/pet_care/medi_help_manager/add_complain', {
                email,
                complain,
            })
    ...
    const complainDetails = async (id) => {
        try {
            const res = await axios.get(`http://localhost:5000/pet_care/medi_help_manager/complainDetails/${id}`)
            if (res.data.message === 'There is an internal error') {
                seterror1(true)
    ...
    const addingResponse = async (id) => {
        ...
        try {
            const res = await axios.post(`http://localhost:5000/pet_care/medi_help_manager/addingResponse`, {
                id,
                newres
            })
        } catch (err) {
    ...
    const deleteMyComplain = async () => {
        try {
            const res = await axios.get(`http://localhost:5000/pet_care/medi_help_manager/deleteMyComplain/${id}`)
            if (res.data.message === 'There is an internal error') {
                seterror(true)
    ...
    const viewmyComplains = async () => {
        try {
            const res = await axios.get(`http://localhost:5000/pet_care/medi_help_manager/viewmyComplains/${clients1}`)
    ...
    const viewClientsComplains = async () => {
        try {
            const res = await axios.get(`http://localhost:5000/pet_care/medi_help_manager/viewClientsComplains/${clients}`)
        ...
        <div className="home-container" style={{ marginTop: '5%' }}>
            <div className="top">
                ...
                <div className="top-line">
                    ...
                    <Button onClick={profile}><img src={getProfilepicturepath("medi_profile.jpg")} alt="profilepicture" className="boarding-profile-picture" /></Button>
                </div>
            </div>
