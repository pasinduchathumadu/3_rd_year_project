...
export default function OrderTable() {
  return (
    <div style={{padding:"100px"}}>
      <h2 style={{marginTop:"20px",fontSize:"40px",textAlign:"center"}}>My Orders</h2>
    <TableContainer component={Paper} sx={{padding:"50px",boxShadow: "none"}}>
      <Table sx={{ minWidth: 700,marginTop:"200px" ,padding:"50px", border: "none"}} aria-label="customized table">
        <TableHead>
