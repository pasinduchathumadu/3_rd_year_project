...
import star from "../../assests/star5.png";
...
function Bath() {
    ...
    const handleScroll = () => {
      ...
      const newScale = 1 + (scrolled * 0.002); // Adjust the scaling factor as needed
      setStarScale(newScale);
    };
    ...
    <div style={{marginTop:'4%'}}>
      ...
      <div style={{ display: 'f', }} data-aos="zoom-in" >
        ...
        >
          ...
          <h2 style={{color:"white",marginLeft:"50px",fontSize:"50px"}}>Mini Grooming</h2>
