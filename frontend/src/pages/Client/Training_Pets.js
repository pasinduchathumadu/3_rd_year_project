...
const Training_Pets = () => {
  ...
  return (
    <div className="fullPage">
      <div style={{width:"100%",height:"60vh",backgroundColor:"#121334",marginTop:"10vh",color:"white"}}  >
      <div style={{width:'50%', float:'left',marginTop:"10vh"}}   >
        <h2 style={{fontSize:"50px",marginLeft:"50px",marginTop:"20px"}}>Dog Training</h2>
        <h2 style={{fontSize:"20px",marginLeft:"50px"}}>We took care your dogs with experts</h2>
        </div>
      ...
      <TabContext value={value}>
        <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
          <TabList onChange={handleChange} aria-label="lab API tabs example">
            ...
            <Tab label="Wednesday" value="2" />
            <Tab label="Friday" value="3" />
          </TabList>
        </Box>
    ...
    <TableContainer component={Paper}>
      <Table sx={{ minWidth: 700, margin:"20px",marginTop:'0px' ,maxWidth:1200}} aria-label="customized table">
        <TableHead>
          <TableRow>
    ...
    <TableContainer component={Paper}>
      <Table sx={{ minWidth: 700, margin:"20px", marginTop:'0px', maxWidth:"1200px"}} aria-label="customized table">
        <TableHead>
          <TableRow>
            <StyledTableCell>Dessert (100g serving)</StyledTableCell>
            <StyledTableCell align="right">Calories</StyledTableCell>
